	...
	public class ExcelExporter:ExporterBase
	{
		...
		public string sFileName
		{
			get { 
				...
				s = guid.ToString().Substring(0, 8).ToLower();
...
//			}
		...
		public virtual void ExportDataGrid(string ReportHeader)
		{
			...
			CurrentPage.Response.AddHeader( "Content-Disposition", "attachment; filename="+sFileName+".xls");
		...
		public virtual void ExportPageToExcel(string ReportHeader,string Type)
		{
			...
			if (Type.ToLower() == "doc")
			{
				CurrentPage.Response.AddHeader("content-disposition", "attachment;filename="+sFileName+".doc");
			...
			else if (Type.ToLower() == "txt")
			{
				CurrentPage.Response.AddHeader("content-disposition", 
					"attachment;filename="+sFileName+".txt");
				CurrentPage.Response.Charset = "";
				//CurrentPage.Response.Cache.SetCacheability(HttpCacheability.NoCache);
		...
		public virtual void ExportHTMLToExcel(string strHTML, string Type)
		{
			...
			#region Type Export
			if (Type.ToLower() == "doc" || Type.ToLower() == "word")
			{
				CurrentPage.Response.AddHeader("content-disposition", "attachment;filename="+sFileName+".doc");
				CurrentPage.Response.Charset = "";
				//CurrentPage.Response.Cache.SetCacheability(HttpCacheability.NoCache);
		...
		#endregion
		#region Export string HTML To
		/// <summary>
		/// Exports the Page to an Excel file with the name of the datasheet provided by the passed in parameter
		/// </summary>
		/// <param name="ReportHeader">Name of the datasheet.
		/// </param>
		public virtual void ExportHTMLTo(string strHTML, string Type)
		{
//			if (Type.ToLower() == "pdf")
//			{
//				CurrentPage.Response.ContentType = "application/pdf";
//				CurrentPage.Response.AddHeader("content-disposition", "attachment;filename="+sFileName+".pdf");
...
//				htmlparser.Parse(sr);
//				pdfDoc.Close();
//				CurrentPage.Response.Write(pdfDoc);
//				CurrentPage.Response.End(); 
//			}
